...
export function PageStatus({
  ...
  return (
    <div className="grid gap-6 rounded-[2rem] border border-line bg-panel p-7 shadow-panel lg:grid-cols-[1.2fr_0.8fr]">
      ...
      <div className="rounded-[1.5rem] border border-line bg-white/92 p-5">
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[linear-gradient(135deg,#0f2745,#1f6fff)] text-sm font-semibold text-white shadow-panel">
          OS
        </div>
        <p className="mt-5 text-sm font-semibold text-ink">当前页面状态</p>
        <p className="mt-2 text-sm leading-6 text-muted">
          如果是首次加载，通常是正在连接真实账户、任务或后台接口；如果停留过久，通常意味着后端未启动，或者当前账号还没有访问权限。
        </p>
